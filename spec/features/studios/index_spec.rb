...
RSpec.describe 'the studio index page' do
  describe 'as a user' do
    it 'I see each studios name and location' do
      ...
      studio_2 = Studio.create(name: 'Walt Disney Studios', location: 'Burbank, CA')
      studio_3 = Studio.create(name: '20th Century Studios', location: 'Century City, CA')

      visit studio_index_path
